        ...
        <Card className="w-full shadow-lg border border-gray-100">
          ...
          <CardContent className="space-y-6 p-6">
            ...
            <div>
              ...
              {/* FIX: value coerced to string; onValueChange typed as string (shadcn Select never passes numbers) */}
              <Select
                value={newStore.mangrID.toString()}
                onValueChange={(value: string) => setNewStore({ ...newStore, mangrID: value })}
              >
